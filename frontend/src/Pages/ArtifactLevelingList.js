...
const ArtifactLevelingList = () => {
  ...
  useEffect(() => {
    ...
    fetchArtifacts();
  }, []); // Remove isEditModalOpen from dependency array
  ...
  return (
    <div className={styles.artifactLevelingList}>
      <h1 className={styles.pageTitle}>Artifact Leveling List</h1>
      <p className={styles.pageSubtitle}>
        Manage and track your artifact leveling progress
      </p>
      ...
      <div className={styles.contentContainer}>
        <div className={styles.statsContainer}>
          <div className={styles.statCard}>
            ...
            <div className={styles.statLabel}>Total Artifacts</div>
          </div>
          <div className={styles.statCard}>
          ...
          <div className={styles.statCard}>
            ...
            <div className={styles.statLabel}>Most Appeared Type</div>
          </div>
        </div>
