  ...
  return (
    <div className={styles.artifact_listing_container}>
      <div className={styles.page_header}>
        <h1 className={styles.page_title}>Artifact Collection</h1>
        <p className={styles.page_subtitle}>
          Manage and view your complete artifact inventory
        </p>
        <div className={styles.stats_bar}>
          <div className={styles.stat_item}>
            <span className={styles.stat_number}>{artifacts.length}</span>
            <span className={styles.stat_label}>Total Artifacts</span>
          </div>
          <div className={styles.stat_item}>
