  ...
  const renderContent = () => {
    if (selectedCategory === 'Main Stat') {
      ...
      return (
        <>
          <div className={styles.button_container}>
            <button className={`${styles.button} ${selectedChart === 'Types' ? styles.active : ''}`} onClick={() => setSelectedChart('Types')}>Types</button>
            <button className={`${styles.button} ${selectedChart === 'Sand' ? styles.active : ''}`} onClick={() => setSelectedChart('Sand')}>Sand</button>
            <button className={`${styles.button} ${selectedChart === 'Goblet' ? styles.active : ''}`} onClick={() => setSelectedChart('Goblet')}>Goblet</button>
            <button className={`${styles.button} ${selectedChart === 'Circlet' ? styles.active : ''}`} onClick={() => setSelectedChart('Circlet')}>Circlet</button>
          </div>
          <ChartTable
            chartType="pie"
