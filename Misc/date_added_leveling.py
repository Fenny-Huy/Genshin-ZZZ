...
# Example usage
artifact_itself_file = "date_added.txt"  # Path to the Artifact itself data file
artifact_leveling_file = "date_added_leveling.txt"  # Path to the Artifact leveling data file
output_file = "leveling_queries.sql"  # Path to the output SQL file
