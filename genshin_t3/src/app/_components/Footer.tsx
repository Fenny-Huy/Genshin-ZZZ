      ...
      <div className="w-full px-4 md:px-8 py-6">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8">
          ...
          <div>
            ...
            <p className="text-sm text-slate-300">
              Genshin Artifact Manager helps you track and manage your Genshin Impact artifacts efficiently, summarizing main stat and substats patterns as well as your luck in leveling up your artifacts.
            </p>
          </div>
        ...
        <div className="mt-6 md:mt-8 pt-4 md:pt-6 border-t border-slate-800 text-center">
          <p className="text-xs md:text-sm text-slate-400">
            © {currentYear} Genshin Artifact Manager. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
