  ...
  return (
    <HydrateClient>
      <main className="flex min-h-[calc(100vh-64px)] flex-col items-center justify-center text-white">
        <div className="container flex flex-col items-center justify-center gap-8 md:gap-12 px-4 py-8 md:py-16">
          <h1 className="text-3xl md:text-5xl font-extrabold tracking-tight sm:text-[5rem] text-center">
            Genshin <span className="text-yellow-500">Artifact</span> Manager
          </h1>
          
          <div className="flex flex-col items-center gap-4 text-center">
            <p className="text-base md:text-2xl text-gray-300 max-w-2xl px-2">
            ...
            {!session && (
              <div className="mt-6 md:mt-8">
                <p className="mb-4 text-base md:text-lg text-gray-400">Sign in to start managing your collection</p>
                <Link
                  href="/api/auth/signin"
                  className="rounded-full bg-yellow-600 px-8 md:px-10 py-2.5 md:py-3 font-semibold text-white no-underline transition hover:bg-yellow-500 shadow-lg shadow-yellow-500/20"
                >
            ...
            {session && (
               <div className="mt-6 md:mt-8 grid grid-cols-1 gap-4 md:gap-6 sm:grid-cols-2 w-full max-w-4xl">
                <Link
                ...
                <Link
                  ...
                  className="flex flex-col gap-3 md:gap-4 rounded-xl bg-slate-800 p-4 md:p-6 border border-slate-700 transition-all hover:bg-slate-700 hover:border-slate-600 hover:shadow-xl hover:-translate-y-1"
                >
                  <h3 className="text-xl md:text-2xl font-bold text-blue-400">View Collection →</h3>
                  <div className="text-sm md:text-lg text-gray-300">
                ...
                <Link
                  ...
                  className="flex flex-col gap-3 md:gap-4 rounded-xl bg-slate-800 p-4 md:p-6 border border-slate-700 transition-all hover:bg-slate-700 hover:border-slate-600 hover:shadow-xl hover:-translate-y-1"
                >
                  <h3 className="text-xl md:text-2xl font-bold text-green-400">Search Artifacts →</h3>
                  <div className="text-sm md:text-lg text-gray-300">
                ...
                <Link
                  ...
                  className="flex flex-col gap-3 md:gap-4 rounded-xl bg-slate-800 p-4 md:p-6 border border-slate-700 transition-all hover:bg-slate-700 hover:border-slate-600 hover:shadow-xl hover:-translate-y-1"
                >
                  <h3 className="text-xl md:text-2xl font-bold text-purple-400">Search Leveling →</h3>
                  <div className="text-sm md:text-lg text-gray-300">
                ...
                <Link
                  ...
                  className="flex flex-col gap-3 md:gap-4 rounded-xl bg-slate-800 p-4 md:p-6 border border-slate-700 transition-all hover:bg-slate-700 hover:border-slate-600 hover:shadow-xl hover:-translate-y-1"
                >
                  <h3 className="text-xl md:text-2xl font-bold text-pink-400">Statistics →</h3>
                  <div className="text-sm md:text-lg text-gray-300">
                ...
                <Link
                  ...
                  className="flex flex-col gap-3 md:gap-4 rounded-xl bg-slate-800 p-4 md:p-6 border border-slate-700 transition-all hover:bg-slate-700 hover:border-slate-600 hover:shadow-xl hover:-translate-y-1"
                >
                  <h3 className="text-xl md:text-2xl font-bold text-cyan-400">Analytics →</h3>
                  <div className="text-sm md:text-lg text-gray-300">
