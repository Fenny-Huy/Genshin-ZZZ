            ...
            <div className="rounded-xl bg-gradient-to-br from-blue-900/30 to-purple-900/30 p-6 border border-blue-800/50 backdrop-blur-sm">
              ...
              <div className="grid gap-4 md:grid-cols-3">
                <div className="rounded-lg bg-slate-800/50 p-4 border border-slate-700">
                  ...
                  <p className="text-sm text-gray-300">
                    View distribution of artifact types (Sand, Goblet, Circlet) and their main stats distribution. Click tabs to switch between different views.
                  </p>
                </div>
                <div className="rounded-lg bg-slate-800/50 p-4 border border-slate-700">
                  <h4 className="mb-2 font-semibold text-yellow-400">Substats</h4>
                  <p className="text-sm text-gray-300">
                    Analyze substat distributions. Use <strong>Overall</strong> for general stats or <strong>Specific</strong> to filter by type and main stat.
                  </p>
                </div>
                <div className="rounded-lg bg-slate-800/50 p-4 border border-slate-700">
              ...
              <div className="mt-4 rounded-lg bg-green-900/20 p-3 border border-green-700/30">
                <p className="text-sm text-green-300">
                  💡 <strong>Tip:</strong> Use the "Filter by Artifact Set" dropdown to focus on specific artifact sets, or leave it empty to see data across all sets.
                </p>
              </div>
            </div>
          )}
